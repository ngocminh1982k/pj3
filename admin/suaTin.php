...
$sql=mysqli_query($con,"select * from tintuc where maTin=$maKH");
...
<div class="form-horizontal">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" maxlength="150" name="tittle" class="form-control" id="itittle"  placeholder="Nhập Tiêu Đề" value="<?php echo($kh["tieuDe"]); ?>"/>
    </div>
  </div>
  <div class="form-group">
    <label for="ides" class="col-sm-2  control-label"> Mô tả : </label>
    <div class="col-sm-10">
      <input type="text" maxlength="255" name="description" id="ides" class="form-control" placeholder="Nhập Mô tả" value=" <?php echo($kh["moTa"]); ?>"/>
    </div>
