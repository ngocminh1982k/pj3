...
<form action="../processing/sualoaipro.php">
  <div class="container">
    
    <label for="maKH">Mã loại sản phẩm</label>
    <input type="text"  name="maKH" readonly="readonly" required value="<?php echo($kh["maLoaiSP"]); ?>">

    <label for="username">Tên loại</label>
    <input type="text" placeholder="Enter name" name="txtName" required value="<?php echo($kh["tenLoaiSP"]); ?>">
