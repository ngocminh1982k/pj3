...
<form action="themkhpro.php">
  <div class="container">
    
    <label for="ten">nhập tên</label>
    <input type="text" placeholder="Please Enter" name="ten" >
	   <label for="age">ngày sinh</label>
    <input type="date" placeholder="Please Enter" name="date" >
	     <label for="email">Địa Chỉ</label>
    <input type="text" placeholder="Please Enter" name="diaChi" >
	   <label for="email">email</label>
    <input type="text" placeholder="Please Enter" name="email" >
	   <label for="sdt">SDT</label>
    <input type="text"  placeholder="Please Enter" name="sdt" >
    <label for="username">userName</label>
    <input type="text" placeholder="Please Enter" name="user">
	  <label for="username">PassWord</label>
    <input type="password" placeholder="Please Enter" name="pass">
