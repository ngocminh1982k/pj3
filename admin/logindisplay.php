...
$pass=$_COOKIE["passpassWord"];
}
?>

<form id="myForm" action="../processing/loginpro.php" onsubmit="return checkForm(this);">
  <div class="container">
    <h1>login</h1>
    <hr>
    ...
    <input type="password" placeholder="Enter Password" name="txtWord" 
