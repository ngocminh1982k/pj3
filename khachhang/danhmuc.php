...
<div id="main">
	...
	<?php
		...
		$resultTongSp=mysqli_query($con,"select count(*) as tongSp from tblsanpham where maLoaiSP=$ma");
	...
	//hien thi san pham
		...
		$sql = mysqli_query( $con, "select * from tblsanpham where maLoaiSP=$ma  limit $start,$soSanPham1Trang" );
	?>
<div id="produc3">
		 <div class="wrapper">
